...
texinfo_documents = [
    (master_doc, 'DocumentacaoLocalizacaoBrasileiraOdoo', u'Documentacão Localização Brasileira',
     author, 'DocumentacaoLocalizacaoBrasileiraOdoo', 'Documentacão Localização Brasileira.',
     'Miscellaneous'),
]
